        ...
        <div v-if="this.$store.state.token">
            ...
            <v-dialog v-model="dialog2" persistent>
                <v-card style="padding: 0px">
                    ...
                    <v-card-title v-if="valor === 6" class="text-h5 mb-5"> Calidad recepción de muestras </v-card-title>
                    ...
                    <v-container v-if="valor === 1">
                        <v-row>
                            ...
                            <v-col cols="5" md="6">
                                <v-text-field class="mt-n7" v-model="aprobacion" label="Aprobación" required dense
                                    filled rounded></v-text-field>
                            </v-col>

                            <v-col cols="5" md="6">
                                <v-text-field class="mt-n7" v-model="version" label="Versión" required dense filled
                                    rounded>
                                </v-text-field>
                            </v-col>
                        </v-row>
                        ...
                        <v-row>
                            ...
                            <v-col cols="12">
                                <v-textarea class="mt-n7" rounded v-model="aceptaciondelservicio" filled auto-grow
                                    label="Aceptación del servicio" row-height="20"></v-textarea>
                            </v-col>
                            <v-col cols="12">
...
export default {
    ...
    data: () => ({
        ...
        TipoCalidad: [
            ...
            { text: "Recepción de muestras", value: 6 },
