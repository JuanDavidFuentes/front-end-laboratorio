  ...
  <v-container fluid class="mt-">
    <v-row class="columna">
      ...
      <v-col cols="12" class="d-flex justify-center">
        <img
          class="mt-2 ml-13 circular--landscape"
...
.triangulo {
  width: 1000;
  height: 1000;
  border-left: 100px solid #eb8c06;
